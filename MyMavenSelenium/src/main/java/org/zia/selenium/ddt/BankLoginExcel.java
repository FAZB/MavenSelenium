...
//		driver.findElement(By.id("user_pass")).sendKeys(password);
		...
		Assert.assertNotEquals(driver.getTitle().contains("User Front"), "User is not able to login. Invalid credentials");
	...
	public static Object[][] passData() {
		...
		//ExcelDataConfig config = new ExcelDataConfig("C:\\Zia-Training\\Eclipse Projects1\\MavenSelenium\\TestData\\BankInputData.xls");
